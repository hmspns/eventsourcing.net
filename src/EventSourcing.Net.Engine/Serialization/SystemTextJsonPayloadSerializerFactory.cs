...
/// <inheritdoc />
public sealed class SystemTextJsonPayloadSerializerFactory : IPayloadSerializerFactory
{
    private readonly SystemTextJsonPayloadSerializer _serializer;
    
    public SystemTextJsonPayloadSerializerFactory(JsonSerializerOptions? options = null)
    {
        if (options == null)
        {
