...
using EventSourcing.Net.Samples.NewtonsoftJson.UserAggregate;
using EventSourcing.Net.Serialization.NewtonsoftJson;
using EventSourcing.Net.Storage.Postgres;
using EventSourcing.Net.Storage.Redis;
using Microsoft.Extensions.DependencyInjection;

const string DB_CONNECTION_STRING = "Host=127.0.0.1;Port=5432;Database=es_events;Username=postgres;Password=P@ssw0rd; Include Error Detail=true;";
